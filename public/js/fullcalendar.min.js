	...
	j.prototype = {
		...
		renderSegHtml: function(t, e) {
			var i, n = this.view,
				...
				d = "";
			return a.unshift("fc-day-grid-event"), !o.allDay && t.isStart && (d = '<span class="fc-time" style="display:none">' + R(n.getEventTimeText(o)) + "</span>"), i = '<span class="fc-title" data-id="'+o.id +'">' + (R(o.title || "") || "&nbsp;") + "</span>", '<a class="' + a.join(" ") + '"' + (o.url ? ' href="' + R(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + ">" + '<div class="fc-content">' + (r ? i + " " + d : d + " " + i) + "</div>" + (l ? '<div class="fc-resizer"/>' : "") + "</a>"
		},
